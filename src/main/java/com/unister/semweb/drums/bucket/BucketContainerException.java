...
/**
 * This exception is thrown, if the a {@link Bucket}, which doesn't exist, is tried to be accessed or an element could
 * not be added.
 * 
...
public class BucketContainerException extends Exception {
    ...
    /**
     * Instantiates a new {@link BucketContainerException} with the given message.
     * 
     * @param message
     */
