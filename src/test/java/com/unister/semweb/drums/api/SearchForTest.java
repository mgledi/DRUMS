...
public class SearchForTest {
    ...
    public void searchForKnownKeys() throws Exception {
        ...
        DRUMS<TestStorable> drums = DRUMS_API.createOrOpenTable(hashFunction, globalParameters);
        ...
        DRUMS<TestStorable> searchDrums = DRUMS_API.createOrOpenTable(hashFunction, globalParameters);
