...
import com.unister.semweb.superfast.storage.bucket.hashfunction.FirstBitHashFunction;
...
public class ConfigurationTest {
    ...
    public void configurationFileTest() throws Exception {
        ConfigurationFile<DummyKVStorable> file = new ConfigurationFile<DummyKVStorable>(100, 10000, 12, 10000, "/data/tmp/db", new FirstBitHashFunction(100), new DummyKVStorable());
    ...
    public void writeAndReadTest() throws Exception {
        ...
        ConfigurationFile<DummyKVStorable> file = new ConfigurationFile<DummyKVStorable>(100, 10000, 12, 10000, "/data/tmp/db", new FirstBitHashFunction(100), prototype);
        file.writeTo(propertyFile);
